...
wget -O /tmp/OPSBRIDGEDB/Ag_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Ag_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Ec_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Ec_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/At_Derby_20120602.zip "http://bridgedb.org/data/gene_database/At_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Bt_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Bt_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Bs_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Bs_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Ce_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Ce_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Cf_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Cf_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Dr_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Dr_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Dm_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Dm_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Gg_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Gg_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Hs_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Hs_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Mm_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Mm_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Oj_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Oj_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Pt_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Pt_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Rn_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Rn_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Sc_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Sc_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Zm_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Zm_Derby_20120602.zip"
wget -O /tmp/OPSBRIDGEDB/Gz_Derby_20120602.zip "http://bridgedb.org/data/gene_database/Gz_Derby_20120602.zip"
cd /tmp/OPSWIKIDUMP
